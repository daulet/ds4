...
def validate_implementation(report: Report, fixture: dict[str, Any], texts: dict[str, str]) -> None:
    ...
    report.check("0_u32.wrapping_sub" in helper, "branchless byte masks missing")
    ...
    report.check('rev = "485bdd86fc1c900ad15ebd421b3b187619fe0903"' in texts["cargo"], "cuda-oxide pin drift")
