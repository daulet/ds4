#!/usr/bin/env python3
"""Compare Rust layer-4 post-ratio128 ratio-4/indexer FFN-output readback against the current-C GPU oracle."""
...
FILES = {
    "c_helper": ROOT / "ds4_layer4_ffn_output_oracle_dump.c",
    "ds4_c": ROOT / "ds4.c",
    "ds4_h": ROOT / "ds4.h",
    "makefile": ROOT / "Makefile",
    "rust_bin": ROOT / "rust/ds4-gpu/src/bin/ds4-decode-layer4-ffn-output.rs",
...
ORACLE_SCHEMA = "ds4.layer4_ffn_output_oracle.v1"
CANDIDATE_SCHEMA = "ds4.decode_layer4_ffn_output.v1"
CASE = "token0_layer4_ffn_output"
MODEL_SIZE = 86720111488
TENSOR_DATA_OFFSET = 5333824
OUTPUTS = {
    "after_layer3_hc": (16384, "f32"),
    "layer4_raw_cache_row": (512, "f32"),
    "layer4_attn_state_kv": (8192, "f32"),
    "layer4_attn_state_score": (8192, "f32"),
    "layer4_index_state_kv": (2048, "f32"),
    "layer4_index_state_score": (2048, "f32"),
    "layer4_heads": (32768, "f32"),
    "layer4_attn_low": (8192, "f32"),
    "layer4_attn_out": (4096, "f32"),
    "layer4_after_attn_hc": (16384, "f32"),
    "layer4_ffn_cur": (4096, "f32"),
    "layer4_ffn_norm": (4096, "f32"),
    "layer4_router_logits": (256, "f32"),
    "layer4_router_probs": (256, "f32"),
    "layer4_router_selected": (6, "i32"),
    "layer4_router_weights": (6, "f32"),
    "layer4_routed_mid": (12288, "f32"),
    "layer4_routed_out": (4096, "f32"),
    "layer4_shared_mid": (2048, "f32"),
    "layer4_shared_out": (4096, "f32"),
    "layer4_after_ffn_hc": (16384, "f32"),
}
WEIGHT_ROLES = {
    "token_embd": "base.token_embd",
    "layer4_hc_attn_fn": "layer4.hc_attn_fn",
    "layer4_hc_attn_scale": "layer4.hc_attn_scale",
    "layer4_hc_attn_base": "layer4.hc_attn_base",
    "layer4_attn_norm": "layer4.attn_norm",
    "layer4_attn_q_a": "layer4.attn_q_a",
    "layer4_attn_kv": "layer4.attn_kv",
    "layer4_attn_q_a_norm": "layer4.attn_q_a_norm",
    "layer4_attn_kv_a_norm": "layer4.attn_kv_a_norm",
    "layer4_attn_q_b": "layer4.attn_q_b",
    "layer4_attn_compressor_kv": "layer4.attn_compressor_kv",
    "layer4_attn_compressor_gate": "layer4.attn_compressor_gate",
    "layer4_attn_compressor_ape": "layer4.attn_compressor_ape",
    "layer4_attn_compressor_norm": "layer4.attn_compressor_norm",
    "layer4_indexer_compressor_kv": "layer4.indexer_compressor_kv",
    "layer4_indexer_compressor_gate": "layer4.indexer_compressor_gate",
    "layer4_indexer_compressor_ape": "layer4.indexer_compressor_ape",
    "layer4_indexer_compressor_norm": "layer4.indexer_compressor_norm",
    "layer4_attn_sinks": "layer4.attn_sinks",
    "layer4_attn_output_a": "layer4.attn_output_a",
    "layer4_attn_output_b": "layer4.attn_output_b",
    "layer4_hc_ffn_fn": "layer4.hc_ffn_fn",
    "layer4_hc_ffn_scale": "layer4.hc_ffn_scale",
    "layer4_hc_ffn_base": "layer4.hc_ffn_base",
    "layer4_ffn_norm": "layer4.ffn_norm",
    "layer4_ffn_gate_inp": "layer4.ffn_gate_inp",
    "layer4_ffn_gate_exps": "layer4.ffn_gate_exps",
    "layer4_ffn_up_exps": "layer4.ffn_up_exps",
    "layer4_ffn_down_exps": "layer4.ffn_down_exps",
    "layer4_ffn_gate_shexp": "layer4.ffn_gate_shexp",
    "layer4_ffn_up_shexp": "layer4.ffn_up_shexp",
    "layer4_ffn_down_shexp": "layer4.ffn_down_shexp",
}
OPTIONAL_WEIGHT_ROLES = {
    "layer4_ffn_exp_probs_b": "layer4.ffn_exp_probs_b",
    "layer4_ffn_gate_tid2eid": "layer4.ffn_gate_tid2eid",
}
EXPECTED_FNV1A64 = {
    ...
    "layer4_shared_out": "abefadb626b0180b",
    "layer4_after_ffn_hc": "b19322ec84d84935",
}
EXPECTED_WEIGHTS = {
    "token_embd": (77928033088, 1059061760, 1, "f16"),
    "layer4_hc_attn_fn": (79791055008, 786432, 1, "f16"),
    "layer4_hc_attn_scale": (79791841440, 12, 0, "f32"),
    "layer4_hc_attn_base": (79791054912, 96, 0, "f32"),
    "layer4_attn_norm": (79762185280, 16384, 0, "f32"),
    "layer4_attn_q_a": (79722077248, 4456448, 8, "q8_0"),
    "layer4_attn_kv": (79648545856, 2228224, 8, "q8_0"),
    "layer4_attn_q_a_norm": (79648541760, 4096, 0, "f32"),
    "layer4_attn_kv_a_norm": (79648539712, 2048, 0, "f32"),
    "layer4_attn_q_b": (79726533696, 35651584, 8, "q8_0"),
    "layer4_attn_compressor_kv": (79618652736, 8388608, 1, "f16"),
    "layer4_attn_compressor_gate": (79610264128, 8388608, 1, "f16"),
    "layer4_attn_compressor_ape": (79610253888, 8192, 1, "f16"),
    "layer4_attn_compressor_norm": (79610262080, 2048, 0, "f32"),
    "layer4_indexer_compressor_kv": (79629141056, 2097152, 1, "f16"),
    "layer4_indexer_compressor_gate": (79627043904, 2097152, 1, "f16"),
    "layer4_indexer_compressor_ape": (79627041344, 2048, 1, "f16"),
    "layer4_indexer_compressor_norm": (79627043392, 512, 0, "f32"),
    "layer4_attn_sinks": (79610253632, 256, 0, "f32"),
    "layer4_attn_output_a": (79650774080, 35651584, 8, "q8_0"),
    "layer4_attn_output_b": (79686425664, 35651584, 8, "q8_0"),
    "layer4_hc_ffn_fn": (79791841568, 786432, 1, "f16"),
    "layer4_hc_ffn_scale": (79792628000, 12, 0, "f32"),
    "layer4_hc_ffn_base": (79791841472, 96, 0, "f32"),
    "layer4_ffn_norm": (79791038528, 16384, 0, "f32"),
    "layer4_ffn_gate_inp": (79762202688, 2097152, 1, "f16"),
    "layer4_ffn_exp_probs_b": (79762201664, 1024, 0, "f32"),
    "layer4_ffn_gate_exps": (7262399296, 553648128, 16, "iq2_xxs"),
    "layer4_ffn_up_exps": (8520690496, 553648128, 16, "iq2_xxs"),
    "layer4_ffn_down_exps": (7816047424, 704643072, 10, "q2_k"),
    "layer4_ffn_gate_shexp": (79764299840, 8912896, 8, "q8_0"),
    "layer4_ffn_up_shexp": (79782125632, 8912896, 8, "q8_0"),
    "layer4_ffn_down_shexp": (79773212736, 8912896, 8, "q8_0"),
}
EXPECTED_OPERATION = {
    "token": 0,
    "first_layer": 0,
...
def main(argv: Iterable[str]) -> int:
    ...
    if report.ok:
        print(f"Rust layer-4 post-ratio128 ratio-4/indexer FFN-output current-C oracle comparator: {report.checks} checks")
    else:
...
def parse_args(argv: Iterable[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--oracle", type=Path, help="JSON from ds4-layer4-ffn-output-oracle-dump")
    parser.add_argument("--candidate", type=Path, help="JSON from ds4-decode-layer4-ffn-output")
...
def validate_static(report: Report, texts: dict[str, str]) -> None:
    ...
    for needle, message in (
        ("ds4_dump_layer4_ffn_output_oracle_json", "C helper does not call exported oracle dump"),
    ...
    ds4_c = texts["ds4_c"]
    for needle, message in (
        ("ds4_dump_layer4_ffn_output_oracle_json", "C oracle dump implementation missing"),
        ...
        ("for (uint32_t il = 0; ok && il < 4; il++)", "C oracle does not encode the first four layers before layer 4"),
        ...
        ("ds4_gpu_tensor_read(g.ffn_cur", "C oracle does not read layer-4 FFN HC-pre current tensor"),
        ("ds4_gpu_tensor_read(g.ffn_norm", "C oracle does not read layer-4 FFN norm tensor"),
        ("ds4_gpu_tensor_read(g.router_logits", "C oracle does not read layer-4 router logits"),
        ("ds4_gpu_tensor_read(g.router_selected", "C oracle does not read layer-4 router selected tensor"),
        ("ds4_gpu_tensor_read(g.routed_mid", "C oracle does not read layer-4 routed intermediate tensor"),
        ("ds4_gpu_tensor_read(g.shared_mid", "C oracle does not read layer-4 shared expert intermediate tensor"),
        ("ds4_gpu_tensor_read(g.after_ffn_hc", "C oracle does not read final layer-4 after-FFN HC"),
        ("layer0_attn_oracle_write_i32_output(fp, \"layer4_router_selected\"", "C oracle does not emit router_selected as i32"),
        ("layer4_hc_ffn_fn", "C oracle does not report layer-4 HC FFN weights"),
        ("layer4_ffn_gate_tid2eid", "C oracle does not report layer-4 router hash table"),
        ("layer4_ffn_down_shexp", "C oracle does not report layer-4 shared down weight"),
        ("\"layer4_after_ffn_hc\"", "C oracle does not emit final layer-4 after-FFN HC"),
        (ORACLE_SCHEMA, "C oracle schema missing"),
    ):
        report.check(needle in ds4_c, message)

    report.check(
        "int ds4_dump_layer4_ffn_output_oracle_json" in texts["ds4_h"],
        "header declaration for layer-4 post-ratio128 ratio-4/indexer FFN-output oracle missing",
    )

    makefile = texts["makefile"]
    report.check("ds4-layer4-ffn-output-oracle-dump:" in makefile, "Makefile helper target missing")
    report.check("ds4_layer4_ffn_output_oracle_dump_cpu.o" in makefile, "CPU helper object missing")
    ...
    for needle, message in (
        ...
        (".hc_split_weighted_sum_norm(", "FFN HC-pre facade call missing"),
        ...
        ("read_tensor_i32_output(\n            \"layer4_router_selected\"", "router_selected i32 readback missing"),
        ("read_tensor_output(\n            \"layer4_after_ffn_hc\"", "layer-4 after-FFN HC readback missing"),
        ("layer4_ffn_gate_tid2eid", "Rust report does not include layer-4 router hash table"),
        ("Output::I32", "mixed f32/i32 output writer missing"),
        ("write_any_output(output", "mixed output dispatcher missing"),
    ...
    report.check(
        "M10.5c4c2b2b2b2b2b2b2b2b1 Rust layer-4 post-ratio128 ratio-4/indexer FFN-output comparator" in report_text,
        "unified report comparator missing",
    )
    report.check(
        "M10.5c4c2b2b2b2b2b2b2b2b1 B300 layer-4 post-ratio128 ratio-4/indexer FFN-output oracle rerun" in report_text,
        "unified report B300 skip missing",
    )
    report.check(
        "ds4-layer4-ffn-output-oracle-dump" in report_text
        and "compare_decode_layer4_ffn_output.py" in report_text,
        "B300 oracle rerun command missing helper/comparator",
    )

    readme = texts["readme"]
    report.check(
        "M10.5c4c2b2b2b2b2b2b2b2b1" in readme
        and "compare_decode_layer4_ffn_output.py" in readme
        and "ds4-layer4-ffn-output-oracle-dump" in readme,
        "README entry missing",
    )
    report.check(
        "M10.5c4c2b2b2b2b2b2b2b2b1: Rust Layer-4 Post-Ratio128 Ratio-4 FFN Output B300 Execution" in texts["roadmap"],
        "roadmap FFN-output split missing",
    )
    report.check(
        "M10.5c4c2b2b2b2b2b2b2b2b: Rust Remaining One-Token Decode B300 Execution" in texts["roadmap"],
        "roadmap one-token remainder split missing",
    )
    report.check(
        "M10.5c4c2b2b2b2b2b2b2b2b1: Rust Layer-4 Post-Ratio128 Ratio-4 FFN Output B300 Execution" in texts["todo"],
        "TODO FFN-output split missing",
    )
    report.check(
        "M10.5c4c2b2b2b2b2b2b2b2b: Rust Remaining One-Token Decode B300 Execution" in texts["todo"],
        "TODO one-token remainder split missing",
    )
    ...
    for index, left_value in left_map.items():
        ...
        if dtype == "i32":
            if left_value != right_value:
                return False
        elif not math.isclose(float(left_value), float(right_value), rel_tol=1e-6, abs_tol=1e-6):
            return False
    return True
...
def run_negative_tests(texts: dict[str, str]) -> int:
    static_mutations = [
        ("remove schema", "rust_bin", CANDIDATE_SCHEMA, "ds4.decode_layer4_ffn_output.removed"),
        ("remove C FFN current", "ds4_c", "ds4_gpu_tensor_read(g.ffn_cur", "ds4_gpu_tensor_read_removed(g.ffn_cur"),
        ("remove C router selected", "ds4_c", "ds4_gpu_tensor_read(g.router_selected", "ds4_gpu_tensor_read_removed(g.router_selected"),
        ("remove C after FFN", "ds4_c", "\"layer4_after_ffn_hc\"", "\"layer4_after_ffn_hc_removed\""),
        ...
        ("remove Rust shared SwiGLU", "rust_bin", ".shared_gate_up_swiglu_q8_0(", ".shared_gate_up_swiglu_q8_0_removed("),
        ("remove Rust shared down", "rust_bin", ".shared_down_hc_expand_q8_0(", ".shared_down_hc_expand_q8_0_removed("),
        ("remove Rust i32 read", "rust_bin", "read_tensor_i32_output(\n            \"layer4_router_selected\"", "read_tensor_i32_output_removed(\n            \"layer4_router_selected\""),
        ("remove B300 candidate check", "report", "compare_decode_layer4_ffn_output.py", "compare_decode_layer4_ffn_output_removed.py"),
        (
            "remove roadmap split",
            "roadmap",
            "M10.5c4c2b2b2b2b2b2b2b2b1: Rust Layer-4 Post-Ratio128 Ratio-4 FFN Output B300 Execution",
            "M10.5c4c2b2b2b2b2b2b2b2b1 removed",
        ),
    ]
    failures: list[str] = []
...
def valid_pair() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    weights = {
        key: {
            ...
            "type": EXPECTED_WEIGHTS.get(key, (0, 0, 1 if key.endswith("_fn") or key.endswith("_inp") else 8, ""))[2],
            "type_name": EXPECTED_WEIGHTS.get(key, (0, 0, 0, "f16" if key.endswith("_fn") or key.endswith("_inp") else "q8_0"))[3],
        }
...
def mutate_candidate_digest(candidate: dict[str, Any]) -> None:
    candidate["outputs"]["layer4_after_ffn_hc"]["fnv1a64"] = "0000000000000000"


def mutate_candidate_sample(candidate: dict[str, Any]) -> None:
    candidate["outputs"]["layer4_routed_out"]["samples"][0]["value"] += 0.01


def mutate_candidate_router_selected(candidate: dict[str, Any]) -> None:
    candidate["outputs"]["layer4_router_selected"]["samples"][0]["value"] += 1


def mutate_candidate_tensor_size(candidate: dict[str, Any]) -> None:
    candidate["outputs"]["layer4_shared_mid"]["elements"] = 1


def mutate_candidate_weight_offset(candidate: dict[str, Any]) -> None:
    candidate["weights"]["layer4_ffn_down_shexp"]["abs_offset"] += 4
...
def print_errors(errors: list[str]) -> None:
    print("Rust layer-4 post-ratio128 ratio-4/indexer FFN-output comparator failures:")
    for error in errors:
        print(f"  - {error}")
