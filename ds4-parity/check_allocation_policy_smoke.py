...
def validate_wiring(report: Report, texts: dict[str, str]) -> None:
    ...
    report.check("Active item: M14.1b3b Q8 Cache And Quality Policy" in texts["status"], "next active stage missing")
