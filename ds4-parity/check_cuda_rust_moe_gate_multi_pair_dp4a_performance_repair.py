...
def validate_implementation(report: Report, kernels: str) -> None:
    ...
    report.check("fn abi_moe_iq2_signed_word" in kernels, "IQ2 packed sign helper missing")
    ...
    report.check("fn abi_moe_q2_q8_k_cached_dot(" in kernels, "unchanged down helper missing")
    report.check("integer::dp4a_i8(" not in down, "down math changed in gate-only leaf")
