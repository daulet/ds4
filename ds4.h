...
int ds4_dump_two_layer_output_head_oracle_json(const char *model_path, int token, FILE *fp);
int ds4_dump_layer2_compressor_state_oracle_json(const char *model_path, int token, FILE *fp);
int ds4_dump_layer2_attn_output_oracle_json(const char *model_path, int token, FILE *fp);
int ds4_dump_layer2_ffn_output_oracle_json(const char *model_path, int token, FILE *fp);
int ds4_dump_layer3_ffn_output_oracle_json(const char *model_path, int token, FILE *fp);
...
int ds4_dump_prefill_whole_short_oracle_json(const char *model_path, const char *prompt_path, int limit_tokens, int resume_prefix_tokens, ds4_backend backend, FILE *fp);
...
/* Borrow the current logits buffer after sync/eval.  The pointer aliases the
 * session and is invalidated by the next session mutation. */
